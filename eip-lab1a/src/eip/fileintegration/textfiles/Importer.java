 ...
 * Explications :
 * 
 * Ce fichier permet d'ouvir un fichier .txt et de le lire
 */
...
public class Importer {
    ...
    public Importer(String filename) throws FileNotFoundException {
        ...
        * En Java, le Reader est une classe abstraite qui représente une source d'entrée de caractères. Le BufferedReader est une classe 
        * concrète qui implémente Reader et qui fournit une méthode pour lire des lignes de caractères en utilisant un buffer interne. 
        * Cela peut améliorer les performances de lecture car les données sont chargées en bloc plutôt qu'un caractère à la fois.
        *  Par conséquent, un BufferedReader peut être considéré comme un Reader avec un buffer interne qui peut être utilisé pour lire 
